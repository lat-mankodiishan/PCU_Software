...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, ADC_RST_Pin|CS_TC1_Pin|CS_TC2_Pin|CS_TC3_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, PDB_RECT_Pin|ADC_START_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_Pin|PDB_BAT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ADC_RST_Pin PDB_RECT_Pin ADC_START_Pin CS_TC1_Pin
                           CS_TC2_Pin CS_TC3_Pin */
  GPIO_InitStruct.Pin = ADC_RST_Pin|PDB_RECT_Pin|ADC_START_Pin|CS_TC1_Pin
                          |CS_TC2_Pin|CS_TC3_Pin;
  ...
  /*Configure GPIO pins : LED_Pin PDB_BAT_Pin */
  GPIO_InitStruct.Pin = LED_Pin|PDB_BAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
