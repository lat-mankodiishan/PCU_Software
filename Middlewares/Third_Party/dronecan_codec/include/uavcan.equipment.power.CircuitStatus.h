...
uint32_t _uavcan_equipment_power_CircuitStatus_encode(struct uavcan_equipment_power_CircuitStatus* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
);
bool _uavcan_equipment_power_CircuitStatus_decode(const CanardRxTransfer* transfer, struct uavcan_equipment_power_CircuitStatus* msg);

static inline uint32_t uavcan_equipment_power_CircuitStatus_encode(struct uavcan_equipment_power_CircuitStatus* msg, uint8_t* buffer
#if CANARD_ENABLE_TAO_OPTION
    , bool tao
#endif
) {

    return _uavcan_equipment_power_CircuitStatus_encode(msg, buffer
#if CANARD_ENABLE_TAO_OPTION
    , tao
#endif
    );
...
static inline bool uavcan_equipment_power_CircuitStatus_decode(const CanardRxTransfer* transfer, struct uavcan_equipment_power_CircuitStatus* msg) {

    return _uavcan_equipment_power_CircuitStatus_decode(transfer, msg);

}

#if defined(CANARD_DSDLC_INTERNAL)

static inline void __uavcan_equipment_power_CircuitStatus_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_equipment_power_CircuitStatus* msg, bool tao);
static inline bool __uavcan_equipment_power_CircuitStatus_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_equipment_power_CircuitStatus* msg, bool tao);
void __uavcan_equipment_power_CircuitStatus_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_equipment_power_CircuitStatus* msg, bool tao) {
...
*/
bool __uavcan_equipment_power_CircuitStatus_decode(const CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_equipment_power_CircuitStatus* msg, bool tao) {
